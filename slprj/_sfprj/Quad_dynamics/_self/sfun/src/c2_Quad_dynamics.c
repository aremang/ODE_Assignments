...
#include <stddef.h>
#include "blas.h"
#include "Quad_dynamics_sfun.h"
#include "c2_Quad_dynamics.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "Quad_dynamics_sfun_debug_macros.h"
...
static void initialize_c2_Quad_dynamics(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance);
static void initialize_params_c2_Quad_dynamics(SFc2_Quad_dynamicsInstanceStruct *
  chartInstance);
static void enable_c2_Quad_dynamics(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance);
static void disable_c2_Quad_dynamics(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_Quad_dynamics
  (SFc2_Quad_dynamicsInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Quad_dynamics
  (SFc2_Quad_dynamicsInstanceStruct *chartInstance);
static void set_sim_state_c2_Quad_dynamics(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_Quad_dynamics(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance);
static void sf_gateway_c2_Quad_dynamics(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance);
static void mdl_start_c2_Quad_dynamics(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_Quad_dynamics(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance);
static void initSimStructsc2_Quad_dynamics(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_Quad_dynamicsInstanceStruct *chartInstance,
  const mxArray *c2_b_y, const char_T *c2_identifier, real_T c2_c_y[6]);
static void c2_b_emlrt_marshallIn(SFc2_Quad_dynamicsInstanceStruct
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
...
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[3]);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_e_emlrt_marshallIn(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[4]);
...
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_f_emlrt_marshallIn(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[9]);
...
static real_T c2_mpower(SFc2_Quad_dynamicsInstanceStruct *chartInstance, real_T
  c2_a);
static void c2_eml_scalar_eg(SFc2_Quad_dynamicsInstanceStruct *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_Quad_dynamicsInstanceStruct *chartInstance);
static void c2_threshold(SFc2_Quad_dynamicsInstanceStruct *chartInstance);
static void c2_c_eml_scalar_eg(SFc2_Quad_dynamicsInstanceStruct *chartInstance);
static void c2_d_eml_scalar_eg(SFc2_Quad_dynamicsInstanceStruct *chartInstance);
static void c2_eml_switch_helper(SFc2_Quad_dynamicsInstanceStruct *chartInstance);
static void c2_mldivide(SFc2_Quad_dynamicsInstanceStruct *chartInstance, real_T
  c2_B[6], real_T c2_Y[6]);
static void c2_check_forloop_overflow_error(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance, boolean_T c2_overflow);
static void c2_eml_xtrsm(SFc2_Quad_dynamicsInstanceStruct *chartInstance, real_T
  c2_A[36], real_T c2_B[6], real_T c2_b_B[6]);
static void c2_below_threshold(SFc2_Quad_dynamicsInstanceStruct *chartInstance);
static void c2_b_eml_switch_helper(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance);
static void c2_scalarEg(SFc2_Quad_dynamicsInstanceStruct *chartInstance);
static void c2_b_eml_xtrsm(SFc2_Quad_dynamicsInstanceStruct *chartInstance,
  real_T c2_A[36], real_T c2_B[6], real_T c2_b_B[6]);
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_g_emlrt_marshallIn(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_h_emlrt_marshallIn(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_Quad_dynamics, const char_T
  *c2_identifier);
static uint8_T c2_i_emlrt_marshallIn(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_eml_xtrsm(SFc2_Quad_dynamicsInstanceStruct *chartInstance,
  real_T c2_A[36], real_T c2_B[6]);
static void c2_d_eml_xtrsm(SFc2_Quad_dynamicsInstanceStruct *chartInstance,
  real_T c2_A[36], real_T c2_B[6]);
static void init_dsm_address_info(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_Quad_dynamicsInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Quad_dynamics = 0U;
}
  ...
  (SFc2_Quad_dynamicsInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_Quad_dynamics;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_Quad_dynamics = c2_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_b_u, 1)),
     "is_active_c2_Quad_dynamics");
  sf_mex_destroy(&c2_b_u);
  c2_update_debugger_state_c2_Quad_dynamics(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_Quad_dynamics(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_Quad_dynamicsMachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_Quad_dynamicsInstanceStruct *chartInstance;
  chartInstance = (SFc2_Quad_dynamicsInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_Quad_dynamics_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_b_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Quad_dynamics), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Quad_dynamics);
  return c2_b_y;
}
...
void sf_c2_Quad_dynamics_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2226313791U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2688079094U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3799849214U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2942089U);
}

mxArray* sf_c2_Quad_dynamics_get_post_codegen_info(void);
mxArray *sf_c2_Quad_dynamics_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("S3yVuqkii6TjNiUANdx9cC");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_Quad_dynamics_get_post_codegen_info();
...
mxArray *sf_c2_Quad_dynamics_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_Quad_dynamics_jit_fallback_info(void)
{
...
mxArray *sf_c2_Quad_dynamics_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_Quad_dynamics(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_Quad_dynamics\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Quad_dynamics_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_Quad_dynamicsInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_Quad_dynamicsMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_Quad_dynamicsMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _Quad_dynamicsMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "ckGsaNnyhfOJfH04aCZSzE";
}

static void sf_opaque_initialize_c2_Quad_dynamics(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_Quad_dynamicsInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_Quad_dynamics((SFc2_Quad_dynamicsInstanceStruct*)
    chartInstanceVar);
  initialize_c2_Quad_dynamics((SFc2_Quad_dynamicsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_Quad_dynamics(void *chartInstanceVar)
{
  enable_c2_Quad_dynamics((SFc2_Quad_dynamicsInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_Quad_dynamics(void *chartInstanceVar)
{
  disable_c2_Quad_dynamics((SFc2_Quad_dynamicsInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_Quad_dynamics(void *chartInstanceVar)
{
  sf_gateway_c2_Quad_dynamics((SFc2_Quad_dynamicsInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_Quad_dynamics(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_Quad_dynamics((SFc2_Quad_dynamicsInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_Quad_dynamics(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_Quad_dynamics((SFc2_Quad_dynamicsInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_Quad_dynamics(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Quad_dynamicsInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Quad_dynamics_optimization_info();
    }

    finalize_c2_Quad_dynamics((SFc2_Quad_dynamicsInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_Quad_dynamics((SFc2_Quad_dynamicsInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Quad_dynamics(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Quad_dynamics(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Quad_dynamics_optimization_info();
  ...
  ssSetChecksum0(S,(2634726373U));
  ssSetChecksum1(S,(3797156950U));
  ssSetChecksum2(S,(1066310502U));
  ssSetChecksum3(S,(1428957326U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_Quad_dynamics(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Quad_dynamics(SimStruct *S)
{
  SFc2_Quad_dynamicsInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_Quad_dynamicsInstanceStruct *)utMalloc(sizeof
    (SFc2_Quad_dynamicsInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_Quad_dynamicsInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_Quad_dynamics;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Quad_dynamics;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_Quad_dynamics;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_Quad_dynamics;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_Quad_dynamics;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Quad_dynamics;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Quad_dynamics;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Quad_dynamics;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_Quad_dynamics;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_Quad_dynamics;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_Quad_dynamics;
...
void c2_Quad_dynamics_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Quad_dynamics(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Quad_dynamics(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Quad_dynamics(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Quad_dynamics_method_dispatcher.\n"
