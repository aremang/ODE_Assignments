...
A = 0.05*l;          %Amplitude of the oscillations
gamma = 0.8;          %Friction coefficient
omega = 80;      %Exitation frequency
% Pendeln blir stabil för ca w >= 52

tau = 0;            %Begynnelsevärde
T = 1e3;             %End time
x0 = [pi+0.1 0]';        %Randvillkor
...
% 	print -depsc2 fig/pp_up_w80_fric08.eps
